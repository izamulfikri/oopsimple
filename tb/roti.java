...
public class roti extends bakery implements item {
    double harga, disc;
    int stok;

    public roti(String nama, String dType, String rasa, String bType, double harga, int stok) {
        super(nama, dType, rasa, bType);
        this.harga = harga;
        this.stok = stok;
    }

    public roti(String nama, String bType, double harga) {
        super(nama, bType);
        super.setDType("Bakery");
        this.harga = harga;
    }
