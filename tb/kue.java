...
public class kue extends bakery implements item {
    double harga, disc;
    int stok;

    public kue(String nama, String dType, String rasa, String bType, double harga, int stok) {
        super(nama, dType, rasa, bType);
        this.harga = harga;
        this.stok = stok;
    }

    public kue(String nama, String bType, double harga) {
        super(nama, bType);
        this.harga = harga;
    }
